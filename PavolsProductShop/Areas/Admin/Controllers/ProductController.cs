...
namespace PavolsProductShop.Areas.Admin.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        {
            var product = new Product(); //CREATE AN EMPTY OBJECT OF PRODUCT FOR ADD ACTION
            product.Category = context.Categories.Find(1); //FIND DEFAULT CATEGORY WHEN CREATING A NEW PRODUCT
        ...
        {
            //FIND PRODUCT, INCLUDE CATEGORY IN THE TABLE, SELECT THE FIRST OR THE DEFAULT PRODUCT THAT MATCHES THE ID OF THE PRODUCT
